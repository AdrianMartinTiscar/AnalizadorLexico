...
public class TinyASint {
	public static abstract class Exp  {
	    ...
	    public static class Dec_proc extends Dec  {
	        ...
	        public StringLocalizado id() {return id;}
	        public ParamForm parF() {return pf;}
	        public Bloque block() {return block;}
	        public void procesa(Procesamiento p) {
	           p.procesa(this); 
	        }     
	    }
	    ...
	    public static class Param_form extends ParamForm{
	    	...
	    	public ParamD par() {return par;}
	    	public LParamForm lpar() {return pars;}
			public void procesa(Procesamiento p) {
				p.procesa(this);
			}
	    }
	    ...
	    public static class TArray extends Tipo{
	    	...
	    	public Num tam() {return n;}
	    	public Tipo of() {return t;}
			public void procesa(Procesamiento p) {
				p.procesa(this);
			}
	    }
	    ...
	    public static class TRecord_varias extends TRecord {
	       ...
	       public Campos campos() {return cs;}
	       public void procesa(Procesamiento p) {
	           p.procesa(this); 
	        }     
	    }
