...
public class ATinyOperations {
	...
	public UnidadLexica unidadPorcentaje() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.PORC);
	}

	public UnidadLexica unidadPunto() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.PNTO);
		}

	public UnidadLexica unidadPuntoComa() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.PTOCOMA);
	}

	public UnidadLexica unidadCorcheteApertura() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.CORAP);
	}

	public UnidadLexica unidadCorcheteCierre() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.CORCIE);
	}

	public UnidadLexica unidadLlaveApertura() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.LLAP);
	}

	public UnidadLexica unidadLlaveCierre() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.LLCIE);
	}

	public UnidadLexica unidadFlecha() {
		return new UnidadLexicaUnivaluada(aLexi.fila(), aLexi.columna(), ClaseLexica.FLECHA);
	}
